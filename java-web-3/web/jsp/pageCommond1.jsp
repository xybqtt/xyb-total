...
<%@ page contentType="text/html;charset=UTF-8"
         language="java" pageEncoding="utf-8" import="java.util.Map"
         errorPage="/jsp/errorPage.jsp" isErrorPage=""
         session="true" extends="java.util.ArrayList" autoFlush="true"
         buffer="8kb"
%>
<html>
    <head>
