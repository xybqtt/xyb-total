...
public class UserDaoImpl implements UserDao {
    ...
    public void operaOneUser(User user) {
        ...
        Object[] objects = new Object[]{user.getUserId(), user.getUserName(), user.getUserStatus()};
    ...
    public void batchOperate(List<Object[]> insData, List<Object[]> updData, List<Object[]> delData) {
        ...
        String updSql = "UPDATE User SET userName = ?, userStatus = ? WHERE userId = ?";
        ...
        List<User> list = jdbcTemplate.query(selSql, new RowMapper(){
            ...
            public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
                ...
                user1.setUserStatus(rs.getString("userstatus"));
                return user1;
            }
        });
